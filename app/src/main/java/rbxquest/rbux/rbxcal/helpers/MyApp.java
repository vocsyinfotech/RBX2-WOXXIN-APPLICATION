...
import com.bhasma.AppOpenManager_Exclude;
import com.bhasma.InstallReferrerHelper;
import com.bhasma.MyAppPizza;
...
public class MyApp extends Application {
    ...
    public void onCreate() {
        ...
        // ── Bhisma SDK init (AdMob + FB + Unity) ─────────────────────────
        // Must come before App Open ad manager construction.
        MyAppPizza.initialize_ads(this, AdConstants.AC_APP_ID, AdConstants.TAPPX);
        Log.d(TAG, "✅ Bhisma SDK initialized (MyAppPizza)");

        // App Open ads — slot 1 tag is "Splash_Screen", other slots empty for now.
        new AppOpenManager_Exclude(this, "Splash_Screen", "", "", "", "");

        // Install Referrer (one-shot async; fires install_referrer_captured event)
        InstallReferrerHelper.fetchIfNeeded(this);
